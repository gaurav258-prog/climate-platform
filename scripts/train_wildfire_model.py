"""
Train wildfire risk ensemble model.

Usage:
    python scripts/train_wildfire_model.py
    python scripts/train_wildfire_model.py --train-end 2022-07-20 --test-start 2022-07-21
    python scripts/train_wildfire_model.py --no-register
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train wildfire risk ensemble model")
    ...
    from ml.training.wildfire_model import train

    logger.info("Starting wildfire ensemble training …")
    result = train(
