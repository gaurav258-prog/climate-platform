...
interface Hist { label: string; total_value: number | null; value_at_risk: number | null; pct_at_risk: number | null }
...
const FRAMEWORKS: Record<string, string> = { bank: 'bank_tcfd', asset_manager: 'sfdr_pai' }
