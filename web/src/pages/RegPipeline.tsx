...
// customers never see our build process — they get the Regulatory outlook (/reg-changes) instead.
...
export default function RegPipeline() {
  ...
  return (
    <div className="fadeup space-y-5">
      <PageHeader eyebrow="Platform · internal delivery" title="Regulatory change pipeline"
        lead="Tellumen's internal board — every new or amended rule tracked from spotted to shipped, so nothing catches a filing off guard. Not customer-facing."
      ...
      {d && (
        <HeroBanner
          ...
          lead="Every new or amended rule tracked from spotted to shipped — monitored, analysed, scheduled, built, tested and released."
          stat={[
