...
const BG='0A1220', CARD='141E2C', CORE='0E2237', HAIR='24324A', HAIR2='33445F';
const INK='EAF1F8', MUTE='94A7BE', FAINT='63768F';
const GREEN='7FB2E6', GREENB='AAD0F0', GOLD='72C8DE';
...
feeds.forEach(c=>{
  ...
  rr(LX,fy+0.235,LW,0.07,'17222F',null,0);                               // scale-bar track
...
s.addShape('ellipse',{x:CX-coreR*0.42,y:CY-coreR,w:2*coreR*0.42,h:2*coreR,fill:{type:'none'},line:{color:'2F4C70',width:0.75}}); // meridian
s.addShape('line',{x:CX-coreR,y:CY,w:2*coreR,h:0,line:{color:'2F4C70',width:0.75}}); // equator
...
s.addShape('ellipse',{x:GX-gR,y:GY-gR,w:2*gR,h:2*gR,fill:{color:'0F2230'},line:{color:GOLD,width:1.5}});
...
p.writeFile({ fileName: '/Users/gauravsachdeva/Downloads/Tellumen-Functional-Architecture-Blue.pptx' }).then(f=>console.log('wrote',f));
