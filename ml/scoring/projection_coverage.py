...
def projection_coverage() -> dict:
    ...
    items = [
        ...
        _entry("soil_degradation", "susceptibility_flat", "land-degradation index is a mapped present state",
               "ISRIC GLADA / FAO degradation index; screening-tier (raster pending)"),
