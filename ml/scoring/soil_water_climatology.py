...
def soil_water_score(sm_z: float, scenario: str = "baseline", horizon: str = "current",
    ...
    TEMPERATURE side (AR6 land/latitude-amplified) plus the AR6 regional PRECIPITATION decline
    (Mediterranean hotspot, 0 elsewhere; soil moisture tracks rainfall)."""
    if sm_z is None:
        return 0.0
