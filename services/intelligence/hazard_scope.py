...
ACUTE = {"flood", "coastal_flood", "storm", "windstorm", "wildfire", "heat_acute", "frost", "cold_wave", "heavy_precip",
         "landslide", "subsidence", "glacial_lake_outburst", "avalanche", "severe_convective"}
