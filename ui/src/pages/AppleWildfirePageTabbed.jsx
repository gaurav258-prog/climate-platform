  ...
  return (
    <div className="w-full overflow-y-auto bg-white">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
        ...
        >
          <source src="/videos/wildfire-background.mp4" type="video/mp4" />
          <source src="/videos/wildfire-background.webm" type="video/webm" />
        </video>
        {/* Overlay for gradient effect */}
        <div
          className="absolute inset-0"
          style={{
            background: 'radial-gradient(circle at 20% 50%, rgba(249, 115, 22, 0.15), transparent 50%), radial-gradient(circle at 80% 80%, rgba(239, 68, 68, 0.1), transparent 50%)'
          }}
        />
      </div>
